...
//  console.log(groups);
//  console.log(groups.length);
// fs.writeFileSync('raw_groups6.txt', JSON.stringify(groups));
...
//  console.log(groups);
//  console.log(groups.length);
// fs.writeFileSync('raw_groups7.txt', JSON.stringify(groups));
...
//         thisMeeting.address1 = "58-66 West 135th Street, New York, NY";
//     }
...
//  console.log(groups);
//  console.log(groups.length);
// fs.writeFileSync('raw_groups8.txt', JSON.stringify(groups));
...
//  console.log(groups);
//  console.log(groups.length);
// fs.writeFileSync('raw_groups9.txt', JSON.stringify(groups));
...
// //     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
//         var addressx = $(elem).find('td').eq(0).html().split('<br>')[2].trim().split(',')[0].replace(/&amp;/g, "@").split('-')[0].trim();
...
//  console.log(groups);
//  console.log(groups.length);
// fs.writeFileSync('raw_groups10.txt', JSON.stringify(groups));
...
/////////////////////Placeholder function to capitalize
// var x = 'clare';
...
//     return str.replace(/\w\S*/g, function(txt){return txt.substr(1).toLowerCase();
//     }

    // var caps = thisMeeting.building;
   // console.log(toTitleCase(thisMeeting.building));
   // thisMeeting.building.push(caps)

// function capitalize(string) {
//     //return string.charAt(0).toUpperCase() + string.slice(1).toLowerCase();
//         return this.toLowerCase() + string.slice(0).toUpperCase();
// }
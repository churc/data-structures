///THIS WORKS CORRECTLY FOR CONSOLE LOG GETTING BOTH 1 AND 2 IN ORDER
//HOWEVER NOT GETTING INFO INTO TABLE - TRY WITH BOTH IN SAME FUNCTION
...
photoresistor1.on("data", function() {
    ...
    // var insertIntoQuery1 = "INSERT INTO lightR VALUES (1 , " + this.value + ", DEFAULT);";
...
photoresistor2.on("data", function() {
   ...
   // var insertIntoQuery2 = "INSERT INTO lightR VALUES (2 , " + this.value + ", DEFAULT);";
      var insertIntoQuery = "INSERT INTO lightR VALUES (2 , " + this.value + ", DEFAULT);"; 
...
///trying to ensure accuracy - appst2.js seems to work but readings go back and forth with 1 and 2

//assignment 9 - writing to db///THIS WORKS TO GET 2 READINGS - CHECKING here in appst3.js TO MAKE SURE
...
//   if (photoresistor = "photoresistor1"){
//     console.log("Window 1:" + this.value);
//     // var insertIntoQuery1 = "INSERT INTO lightR VALUES (1 , " + this.value + ", DEFAULT);";
//         var insertIntoQuery = "INSERT INTO lightR VALUES (1 , " + this.value + ", DEFAULT);";
//       }
 
// else if (photoresistor = "photoresistor2"){
//     console.log("Window 2:" + this.value);
//    // var insertIntoQuery2 = "INSERT INTO lightR VALUES (2 , " + this.value + ", DEFAULT);";
//       var insertIntoQuery = "INSERT INTO lightR VALUES (2 , " + this.value + ", DEFAULT);"; 
//  }

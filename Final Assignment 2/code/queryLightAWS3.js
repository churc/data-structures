...
var queryHght04 = "SELECT * FROM lightP AS hght1 WHERE dateCreated >= '2016-12-05 11:30:00' AND dateCreated <'2016-12-05 23:30:00' AND windowNo ='1' ORDER BY reading DESC LIMIT 1;";
var queryHght05 = "SELECT * FROM lightP AS hght2 WHERE dateCreated >= '2016-12-05 11:30:00' AND dateCreated <'2016-12-05 23:30:00' AND windowNo ='2' ORDER BY reading DESC LIMIT 1;";
var queryHght06 = "SELECT * FROM lightP AS hght3 WHERE dateCreated >= '2016-12-07 11:30:00' AND dateCreated <'2016-12-07 23:30:00' AND windowNo ='1' ORDER BY reading DESC LIMIT 1;";
var queryHght07 = "SELECT * FROM lightP AS hght4 WHERE dateCreated >= '2016-12-07 11:30:00' AND dateCreated <'2016-12-07 23:30:00' AND windowNo ='2' ORDER BY reading DESC LIMIT 1;";

var queryHght08 = "SELECT * FROM lightP AS hght5 WHERE dateCreated >= '2016-12-12 11:30:00' AND dateCreated <'2016-12-12 23:30:00' AND windowNo ='1' ORDER BY reading DESC LIMIT 1;";
var queryHght09 = "SELECT * FROM lightP AS hght6 WHERE dateCreated >= '2016-12-12 11:30:00' AND dateCreated <'2016-12-12 23:30:00' AND windowNo ='2' ORDER BY reading DESC LIMIT 1;";

var queryHght10 = "SELECT * FROM lightP AS hght7 WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND windowNo ='1' ORDER BY reading DESC LIMIT 1;";
var queryHght11 = "SELECT * FROM lightP AS hght8 WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND windowNo ='2' ORDER BY reading DESC LIMIT 1;";
...
////////FOR CIRCULAR CHARTS: readings grouped into brightness for Dec 18 - these will each be color coded to read differently on circular chart
var queryNight18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS nt WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading < 50 ORDER BY dateCreated;";
var queryNearlyDark18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS nd WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 50 AND reading < 200 ORDER BY dateCreated;";
var queryDusk18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS dk WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 200  AND reading < 350 ORDER BY dateCreated;";
var queryVeryDim18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS vd WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 350 AND reading < 500 ORDER BY dateCreated;";
var queryDim18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS vb WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 500 AND reading < 650  ORDER BY dateCreated;";
var queryLight18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS lr WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 650 AND reading < 800 ORDER BY dateCreated;";
var queryBright18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS bt WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading > 800 AND reading < 950 ORDER BY dateCreated;";
var queryVeryBright18 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS vb WHERE dateCreated >= '2016-12-18 11:30:00' AND dateCreated <'2016-12-18 23:30:00' AND reading >= 950 ORDER BY dateCreated;";
...
////December 12 all readings - date time stamp simplified into hours and mins (UTC) ordered by time
var queryLong5 = "SELECT windowNo, reading, EXTRACT(HOUR from dateCreated) as hr, EXTRACT(MINUTE from dateCreated) as min FROM lightP AS long3 WHERE dateCreated >= '2016-12-12 11:30:00' AND dateCreated <'2016-12-12 23:30:00' AND windowNo = '2' AND reading >= 650 ORDER BY hr;";
...
// ////TO GET HIGHEST READING on Dec 12 for window 1
// client.query(queryHght08, function(err, result) {
// //call `done()` to release the client back to the pool
// done();
...
//  ////TO GET HIGHEST READING on Dec 12 for window 2
//  client.query(queryHght09, function(err, result) {
// //call `done()` to release the client back to the pool
// done();
...
// ////TO GET HIGHEST READING on Dec 18 for window 1
// client.query(queryHght10, function(err, result) {
// //call `done()` to release the client back to the pool
// done();
...
//  ////TO GET HIGHEST READING on Dec 18 for window 2
//  client.query(queryHght11, function(err, result) {
// //call `done()` to release the client back to the pool
// done();
...
//                                    /////////////////////////////////////////////////////
//                                  /////////FOR DEC 18 GROUPED READINGS - THESE ARE FOR CIRCULAR CHARTS
            // client.query(queryNight18, function(err, result) {
            // done();
            ...
            // client.query(queryNearlyDark18, function(err, result) {
            //     done();
            ...
            //     client.query(queryDusk18, function(err, result) {
            //         done();
            ...
            //         client.query(queryVeryDim18, function(err, result) {
            //             done();
            ...
            //             client.query(queryDim18, function(err, result) {
            //                 done();
            ...
            //                 client.query(queryLight18, function(err, result) {
            //                     done();
            ...
            //                     client.query(queryBright18, function(err, result) {
            //                         done();
            ...
            //                         client.query(queryVeryBright18, function(err, result) {
            //                             done();
            ...
            //                             //                                                                 ////////////////////////////////////////////////////
                                        ...
                                        ////                                                                                        December 12 number of times where light is 650 and over ordered by hr      
                                        //                                                                                          client.query(queryLong5, function(err, result) {
                                        //                                                                                          done();

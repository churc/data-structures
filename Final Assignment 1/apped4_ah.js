...
///GO TO clean_apped4_ah2.js TO CLEAN UP LINES, DO 24 HRS 
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
    ...
    if (thisMeeting.address1 === "232 W. 11th Street, New York, NY"){
        ...
        if (thisMeeting.address1 === "487 Hudson St, New York, NY") {
            thisMeeting.address1 = "487 Hudson Street, New York, NY";
        }
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
    ...
    if (thisMeeting.address1 === "61 Fourth Avenue, New York, NY") {
      thisMeeting.address1 = "61 4th Avenue, New York, NY"; 
    }

    if (thisMeeting.address1 === "119 Ninth Avenue, New York, NY") {
      thisMeeting.address1 = "119 9th Avenue, New York, NY"; 
    }
    ...
    if (thisMeeting.address1 === "307 W. 26th St., New York, NY") {
      thisMeeting.address1 = "307 West 26th Street, New York, NY"; 
    }
    if (thisMeeting.address1 === "80 St. Mark&apos;s Place, New York, NY") {
      thisMeeting.address1 = "80 St Marks Place, New York, NY"; 
    }
     if (thisMeeting.address1 === "127 East 22nd Street, New York, NY") {
      thisMeeting.address1 = "127 E 22nd Street, New York, NY"; 
    }
     if (thisMeeting.address1 === "414 East 14th Street, New York, NY") {
      thisMeeting.address1 = "414 E 14th Street, New York, NY"; 
    }
    ...
    if (thisMeeting.address1 === "202 West 24 Street, New York, NY") {
      thisMeeting.address1 = "202 West 24th Street, New York, NY"; 
    }
    if (thisMeeting.address1 === "10 East Union Square, New York, NY") {
      thisMeeting.address1 = "10 Union Square East, New York, NY"; 
    }
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
    ...
    thisMeeting.address1 = addressx.concat(", New York, NY");
     ...
     if (thisMeeting.address1 === "1000 Tenth Avenue, New York, NY"){
         thisMeeting.address1 = "1000 10th Avenue, New York, NY";
     }
      if (thisMeeting.address1 === "422 W. 57th St., New York, NY"){
         thisMeeting.address1 = "422 West 57th Street, New York, NY";
     }
   if (thisMeeting.address1 === "296 9th Avenue, New York, NY"){
         thisMeeting.address1 = "296 Ninth Ave, New York, NY";
     }
      if (thisMeeting.address1 === "296 Ninth Avenue, New York, NY"){
         thisMeeting.address1 = "296 Ninth Ave, New York, NY";
     }
    if (thisMeeting.address1 === "422 W. 57th Street, New York, NY"){
        thisMeeting.address1 = "422 West 57th Street, New York, NY";
     }
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
    ...
    if (thisMeeting.address1 === "221 West 107th Street, New York, NY") {
        thisMeeting.address1 = "221 W 107th Street, New York, NY";
    }
      if (thisMeeting.address1 === "3 West 95th Street, New York, NY") {
        thisMeeting.address1 = "3 W 95th Street, New York, NY";
    }
    if (thisMeeting.address1 === "26 West 84th Street, New York, NY") {
        thisMeeting.address1 = "26 W 84th Street, New York, NY";
    }
     if (thisMeeting.address1 === "152 West 71st street, New York, NY") {
        thisMeeting.address1 = "152 West 71st street, New York, NY";
    }
    if (thisMeeting.address1 === "152 west 71st street, New York, NY") {
        thisMeeting.address1 = "152 W 71st Street, New York, NY";
    }
        if (thisMeeting.address1 === "152 West 71st Street, New York, NY") {
        thisMeeting.address1 = "152 W 71st Street, New York, NY";
    }
    ...
    if  (thisMeeting.address1 === "Central Park West &amp; 76th Street, New York, NY"){
     ...
     if  (thisMeeting.address1 === "30 West 68th Street, New York, NY"){
        thisMeeting.address1 = "30 W 68th Street, New York, NY";
    }

      if  (thisMeeting.address1 === "368 West End Ave, New York"){
        thisMeeting.address1 = "368 West End Avenue, New York";
    }
      if  (thisMeeting.address1 === "152 West 71st Street, New York, NY"){
        thisMeeting.address1 = "152 W 71st Street, New York, NY";
    }

      if  (thisMeeting.address1 === "164 West 74 Street, New York, NY"){
        thisMeeting.address1 = "164 West 74th Street, New York, NY";
    }
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
  ...
  if (thisMeeting.address1 === "351 East 74th Street, New York, NY") {
        thisMeeting.address1 = "351 E 74th Street, New York, NY";
    }  
    if (thisMeeting.address1 === "1393+York+Avenue,+New+York,+NY") {
         thisMeeting.address1 = "1393+York+Ave,+New+York,+NY";
    }
     if (thisMeeting.address1 === "520+Park+Avenue,+New+York,+NY") {
         thisMeeting.address1 = "520+Park+Ave,+New+York,+NY";
    }
    if (thisMeeting.address1 === "337 E. 74th St., New York, NY") {
        thisMeeting.address1 = "337 East 74th Street, New York, NY";
    }
     if (thisMeeting.address1 === "1157 Lexington Avenue, New York, NY") {
        thisMeeting.address1 = "1155 Lexington Ave, New York, NY";
    }
    if (thisMeeting.address1 === "351 East 74th St., New York, NY") {
        thisMeeting.address1 = "351 E 74th Street, New York, NY";
    }
    if (thisMeeting.address1 === "420 East 76th Street, New York, NY") {
        thisMeeting.address1 = "420 E 76th Street, New York, NY";
    }
    if (thisMeeting.address1 === "Church of the Good Shepard, New York, NY") {
        thisMeeting.address1 = "543 Main Street, New York, NY";
    }
...
//     //////////ADDRESS CLEAN - TO FIRST COMMA, THEN ADD NY NY
    ...
    if(thisMeeting.address1 === "204 West 134th Street, New York, NY") {
        thisMeeting.address1 = "204 W 134th Street, New York, NY";
    }


    if(thisMeeting.address1 === "2044 Adam Clayton Powell Blvd., New York, NY") {
        thisMeeting.address1 = "2044 Adam Clayton Powell Jr Boulevard, New York, NY";
    }
      if(thisMeeting.address1 === "521 W 126th St, New York, NY") {
        thisMeeting.address1 = "521 West 126th Street, New York, NY";
    }
      if(thisMeeting.address1 === "2044 Seventh Avenue, New York, NY") {
        thisMeeting.address1 = "2044 7th Avenue, New York, NY";
    }
      if(thisMeeting.address1 === "204 West 134th Street, New York, NY") {
        thisMeeting.address1 = "204 W 134th Street, New York, NY";
    }
     if(thisMeeting.address1 === "58, New York, NY") {
        thisMeeting.address1 = "60 West 135th Street, New York, NY";
    }

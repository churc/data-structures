...
// // ////AFTER clean_apped4_ah2.js //GO TO class3geo.js TO GET LAT LONG FOR THE TXT FILE ADDRESSES
////AFTER YOU HAVE geocodes, join in clean_apped8_ah2.js/ class3
///then take joined files GO TO clean_apped6_ah.js/homework 1 TO INSERT RESULTING TXT FILES INTO MONGO
...
async.eachSeries(rawData, function(value, callback){
    ...
    for (var i=0; i < value.meetings.length; i++) {
        ...
        if (thisIt.substr(thisIt.indexOf(' ')-4, 4) == 'days') {
            thisMeeting.days = thisIt.substr(3, thisIt.indexOf(' ')-3);
        }
        
///////////THIS WORKS TO TAKE S OFF DOW AND GET NUMBER FOR EACH DAY  
        if (thisIt.substr(thisIt.indexOf(' ')-4, 4) == 'days') {
            thisMeeting.day = thisIt.substr(3, thisIt.indexOf(' ')-4);
            thisMeeting.dayQuery = weekdays.indexOf(thisMeeting.day);
        }
...
/////THIS WORKS TO GET SHORT meetingType
        ...
        if (thisIt.substr(0, 10) == '<b>Special') {
